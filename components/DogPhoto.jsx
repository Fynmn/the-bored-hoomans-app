              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="py-6 pb-12">
                    {loading ? (
                      <div className="w-64 h-64 sm:w-72 sm:h-72 flex justify-center items-center mx-auto my-auto">
                        <div className="loading-spinner"></div>
                      </div>
                    ) : (
                      <div className="relative p-6 flex justify-center w-64 h-64 sm:w-72 sm:h-72 mx-auto">
                        <Image
                          src={dogURL}
                          alt="Dog"
                          width={300}
